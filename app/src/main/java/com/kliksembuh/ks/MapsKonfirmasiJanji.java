...
public class MapsKonfirmasiJanji extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_konfirmasi_janji);
...
//        alamat = "Jakarta";
        ...
        Toolbar newToolbar = (Toolbar)findViewById(R.id.toolbarMapsKonfirmasiJanji);
        setSupportActionBar(newToolbar);
        newToolbar.setTitle("Peta "+namaRumahSakit);
        setSupportActionBar(newToolbar);
        getWindow().setStatusBarColor(ContextCompat.getColor(MapsKonfirmasiJanji.this, R.color.colorPrimaryDark));
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapkonfirmasijanji);
